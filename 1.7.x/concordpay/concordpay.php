    ...
    public function getExternalPaymentOption()
    {
        ...
        $externalOption->setCallToActionText($this->l('Payment Visa, Mastercard, Google Pay, Apple Pay'))
            ...
            ->setAdditionalInformation(
                $this->context->smarty->fetch('module:concordpay/views/templates/front/concordpay.tpl')
            )
            ->setLogo(Media::getMediaPath(_PS_MODULE_DIR_ . $this->name . '/views/img/concordpay.png'));
